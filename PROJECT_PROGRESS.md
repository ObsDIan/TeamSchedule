...
| **階段 3** | 個人月曆與每週預設設定頁面 (UI/UX) | ✅ 已完成 | `PersonalController`、`Calendar.cshtml` (CSS Grid + Modal AJAX 異動)、`WeeklySetup.cshtml`、**全站深色模式切換 (Dark Mode)**、**整合「首頁設計參考.html」至首頁 (Index.cshtml) 並達成全站 UI/UX 風格統一**。 |
