...
namespace TeamSchedule.Data.Migrations
{
    ...
    [Migration("20260813013335_AddTimeSlotsToActivities")]
    partial class AddTimeSlotsToActivities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeamSchedule.Models.ActivityCandidateDate", b =>
                {
                    ...
                    b.HasIndex("ActivityId", "CandidateDate", "StartTime", "EndTime")
                        .IsUnique()
            ...
            modelBuilder.Entity("TeamSchedule.Models.TeamActivity", b =>
                {
                    ...
                    b.Property<TimeSpan?>("FinalEndTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan?>("FinalStartTime")
                        .HasColumnType("time");
